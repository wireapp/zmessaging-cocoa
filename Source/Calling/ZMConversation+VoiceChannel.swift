...
public extension ZMConversation {
    ...
    var voiceChannel : VoiceChannelRouter? {
        ...
        get {
            ...
            if let voiceChannel = objc_getAssociatedObject(self, &voiceChannelAssociatedKey) as? VoiceChannelRouter {
                return voiceChannel
            } else {
                let voiceChannel = VoiceChannelRouter(conversation: self)

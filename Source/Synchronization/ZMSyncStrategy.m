                               ...
                               applicationStatusDirectory:(ApplicationStatusDirectory *)applicationStatusDirectory
{
    ...
    self.missingUpdateEventsTranscoder = [[ZMMissingUpdateEventsTranscoder alloc] initWithSyncStrategy:self previouslyReceivedEventIDsCollection:self.eventDecoder applicationStatus:applicationStatusDirectory];

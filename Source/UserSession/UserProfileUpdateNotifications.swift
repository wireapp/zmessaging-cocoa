...
extension UserProfileUpdateStatus {
    ...
    @objc(addObserver:) public func add(observer: UserProfileUpdateObserver) -> Any {
        return NotificationInContext.addObserver(name: UserProfileUpdateNotification.notificationName, context: managedObjectContext.zm_userInterface) { [weak observer] (note) in

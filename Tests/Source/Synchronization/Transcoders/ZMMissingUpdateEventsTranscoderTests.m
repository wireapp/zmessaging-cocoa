...
@property (nonatomic) NotificationStreamFetchState mockNotificationSteamFetchState;
...
- (void)setUp {
    ...
    self.mockNotificationSteamFetchState = NotificationStreamFetchStateInProgress;
    ...
    [[[self.mockApplicationDirectory stub] andReturnValue:@(ZMSynchronizationStateSlowSyncing)] synchronizationState];
    ...
    [[[self.mockApplicationDirectory stub] andDo:^(NSInvocation *invocation) {
        NotificationStreamFetchState value = self.mockNotificationSteamFetchState;
        [invocation setReturnValue:&value];
    }] notificationStreamFetchState];
...
- (void)expectMockPushNotificationStatus:(NotificationStreamFetchState)state inBackground:(BOOL)backgrounded
{
    self.application.applicationState = backgrounded ? UIApplicationStateBackground : UIApplicationStateActive;
    self.mockNotificationSteamFetchState = state;
}

- (void)testThatItDoesNotReturnARequestItselfFromAPushWhenThePushNotificationStatusIsNotInProgress
{
    // given
    [self expectMockPushNotificationStatus:NotificationStreamFetchStateDone inBackground:YES];
...
{
    // given
    [self expectMockPushNotificationStatus:NotificationStreamFetchStateInProgress inBackground:YES];
...
{
    // given
    self.mockNotificationSteamFetchState = NotificationStreamFetchStateDone;

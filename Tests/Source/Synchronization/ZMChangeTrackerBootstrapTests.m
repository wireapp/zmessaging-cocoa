...
@interface ZMChangeTrackerBootstrapTests : MessagingTest
...
- (void)setUp
{
    ...
    self.connection1 = [ZMConnection insertNewObjectInManagedObjectContext:self.uiMOC];
    ...
    self.sut = [[ZMChangeTrackerBootstrap alloc] initWithManagedObjectContext:self.uiMOC changeTrackers:@[self.changeTracker1, self.changeTracker2]];
}
...
- (void)testThatItDoesNotReturnAnythingIfThePredicateDoesNotMatch
{
    ...
    self.sut = [[ZMChangeTrackerBootstrap alloc] initWithManagedObjectContext:self.uiMOC changeTrackers:@[self.changeTracker1]];

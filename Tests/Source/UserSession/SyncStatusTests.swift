...
// MARK: Background TODO jacob
//extension SyncStatusTests {
//
//    func testThatItGoesToStateIdleWhenEnteringTheBackground(){
//        // given
//        XCTAssertEqual(sut.currentSyncPhase, .fetchingLastUpdateEventID)
//        
//        // when
...
//        
//        // then
//        XCTAssertEqual(sut.currentSyncPhase, .idle)
//
//    }
//    
//    func testThatItStartsQuickSyncWhenEnteringForeground_lastStateDone(){
//        // given
//        uiMOC.zm_lastNotificationID = UUID.timeBasedUUID() as UUID
//        sut = SyncStatus(managedObjectContext: uiMOC, syncStateDelegate: mockSyncDelegate)
//        sut.didFinish(.fetchingMissedEvents)
...
//    }
//    
//    func testThatItContinuesSlowSyncWhenEnteringForeground_lastStateNotDone(){
//        // given
//        XCTAssertEqual(sut.currentSyncPhase, .fetchingLastUpdateEventID)
//        
//        // when
